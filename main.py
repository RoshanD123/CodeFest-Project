...
def travel(x):
    ...
    if th not in acns:
        ...
        if th == "yes":
            ...
            if fun not in acns:
                ...
                while True:
                    ...
                    if peeps >= 55 and not x == "none":
                        print("\nYou are at a higher risk to have", x,
                              "please go to a doctor to keep yourself safe")
                        print(
                            "\nThank you so much for using our application.  Hope you get better soon!"
                        )
                        break

                    elif peeps >= 55 and x == "none":
                        print(
                            "You have a higher risk of catching covid in general, take a test(COVID test) to be sure"
                        )
                        print(
                            "\nThank you so much for using our application.  Hope you get better soon!"
                        )
                        ...
                        print(
                            "Good.  Take care of yourself.  Though there were few people, you still may have a risk of COVID-19. "
                        )
                        print(
                            "\nThank you so much for using our application.  Hope you get better soon!"
                        )
                        ...
                        print(
                            "Good, you have a lower risk of having", x,
                ...
                print(
                    "Good job for avoiding mass gatherings, but ensure to stay at home and maintain all social protocols at the place you are at. "
                )
                print(
                    "\nThank you so much for using our application.  Hope you get better soon!"
                )
            ...
            print(
                "Good Job, but now follow all COVID protocols and dont go to large crowds"
            )
            print(
                "\nThank you so much for using our application.  Hope you get better soon!"
            )
