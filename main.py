...
def ID(x,y,z,p,c,a):
  IDDICT={"Name":y,"Age":z,"Disease":x,"Doses":a,"Prediction":p,"Prescription":c}
  print(IDDICT)

def travel(x,y,z,p,a):
  acns=["yes","no"]
    ...
    if fun not in acns:
     ...
     return
      ...
      if peeps>=55 and not x=="none":
        ...
        c="You are at a higher risk to have",x,"please go to a doctor to keep yourself safe"
        ID(x,y,z,p,c,a)
      elif peeps>=55 and x=="none":
        print("You have a higher risk of catching covid in general, take a test(COVID test) to be sure")
        c="You have a higher risk of catching covid in general, take a test(COVID test) to be sure"
        ID(x,y,z,p,c,a)
      elif peeps<55 and x=="none":
        print("Good. Take care of yourself. Though there were few people, you still may have a risk of COVID-19.")
        c="Good. Take care of yourself. Though there were few people, you still may have a risk of COVID-19"
        ID(x,y,z,p,c,a)
      else:
        print("Good, you have a lower risk of having",x,", but from now on, avoid crowds to ensure your safety")
        c="Good, you have a lower risk of having",x,", but from now on, avoid crowds to ensure your safety"
        ID(x,y,z,p,c,a)
           ...
           if headache not in acns:
             ...
             if loss_of_smell not in acns:
              ...
              if dis=="yes" and cough=="yes" and runny_nose=="yes" and sneezing=="yes" and shortness_of_breath=="yes" and sore_throat=="yes"and fever=="yes" and night_sweats=="yes" and chills=="yes" and headache=="yes" and loss_of_smell=="yes"and fatigue=="yes":
                ...
                h="You are in an extreme chronic condition and so go to a doctor as soon as possible."
                travel(v,y,z,h,a)
                ...
                h="Be careful as you are in dangerous condition, and maintain COVID protocols all the time to ensure your safety."
                travel(v,y,z,h,a)
                ...
                if cough==a and runny_nose==a and sneezing==b and shortness_of_breath==a and sore_throat==a and fever==a and night_sweats==b and chills==a and headache==a and loss_of_smell==a and fatigue==a and Time==4 or Time==5:
                 ...
                 h="You are most likely to have Delta Variant of COVID"
                travel(d,y,z,h,a)
                ...
                h="You are most likely to have the Omicron Variant of COVID"
                travel(o,y,z,h,a)
                ...
                h="You are most likely to have the flu"
                travel(f,y,z,h,a)
                ...
                h="You are most likely to have the common cold"
                travel(c,y,z,h,a)
              else:
                 if cough==b and runny_nose==a and sneezing==a and shortness_of_breath==b and sore_throat==a and fever==b and night_sweats==b and chills==b and headache==a and loss_of_smell==b and fatigue==a and Time==2 or Time==3:
                  ...
                  h="You might have Omnicron Variant of COVID"
                  travel(o,y,z,h,a)
                  ...
                  travel(f,y,z,h,a)
                   ...
                   h="You might have the common cold"
                   travel(c,y,z,h,a)
                  ...
                  h="You are in no danger, but be careful and follow all COVID protocols to ensure your safety and the safety of others around you"
                  travel(v,y,z,h,a)  
